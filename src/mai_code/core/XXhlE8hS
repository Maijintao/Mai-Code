...
from mai_code.core.bus.events import RunFinishedEvent, RunStartedEvent
from mai_code.core.compact.compactor import Compactor
from mai_code.core.config import MaiConfig
from mai_code.core.context import ExecutionContext
from mai_code.core.events.bus import EventBus, EventHandler
from mai_code.core.events.writer import EventWriter
from mai_code.core.llm.base import LLMProvider
from mai_code.core.llm.provider import AnthropicProvider
from mai_code.core.loop import AgentLoop
from mai_code.core.mcp.server import McpServerManager
from mai_code.core.memory.loader import load_context_file
from mai_code.core.permissions.manager import PermissionManager
from mai_code.core.runs import RUNS_DIR, new_run_id
from mai_code.core.session.model import Session
from mai_code.core.session.store import SessionStore
from mai_code.core.subagent.registry import BackgroundTaskRegistry
from mai_code.core.subagent.tool import AgentResultTool, SpawnAgentTool
from mai_code.core.task.manager import TaskManager
from mai_code.core.tools.builtin import (
    BashTool,
    ListDirTool,
    NoteSaveTool,
    ReadFileTool,
...
from mai_code.core.tools.registry import ToolRegistry
from mai_code.core.trace.provider import TracingProvider
...
class AgentRunner:
    ...
    async def run_and_capture(
        ...
        *,
        ...
        global_ctx = load_context_file(Path("~/.mai/context.md").expanduser())
        project_ctx = load_context_file(Path(".mai/context.md"))
