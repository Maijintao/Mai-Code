...
from mai_code.core.permissions.policy import (
    DEFAULT_POLICIES,
    PermissionDecision,
    ToolPolicy,
    matches_outside_cwd,
...
from mai_code.core.permissions.storage import load_policy_file, save_policy_file
...
class PermissionManager:
    ...
    def evaluate(self, tool_name: str, params: dict[str, Any]) -> PermissionDecision:
        from mai_code.core.permissions.policy import evaluate
