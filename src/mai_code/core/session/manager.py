...
from mai_code.core.bus.envelope import HandlerError
from mai_code.core.bus.events import (
    SessionClosedEvent,
    SessionCreatedEvent,
...
from mai_code.core.runs import new_run_id
from mai_code.core.session.model import Session, SessionMode
...
class SessionManager:
    ...
    async def compact(self, sid: str, focus: str = "") -> Any:
        ...
        async with lock:
            from mai_code.core.bus.commands import SessionCompactResult
